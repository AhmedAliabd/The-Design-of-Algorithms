...
public class Main {
	...
	// write your code here
       ...
       //String text = "Hello BW Students this is Ahmed I am also a Student at BW 2021";

        String text = "Egestas accumsan tortor leo ultrices. Nostra placerat suspendisse. Eros. Nonummy proin. Tellus. Penatibus pretium dictumst. Nibh elit platea viverra, cubilia fusce euismod hendrerit class consequat ullamcorper sociis suscipit quam netus. Magna netus.\n" +
                "\n" +
...
// String text = "Dashwood contempt on mr unlocked resolved provided of of. Stanhill wondered it it welcomed oh. Hundred no prudent he however smiling at an offence. " +
...
//         " too but increasing celebrated principles joy. Herself too improve gay winding ask expense are compact. New all paid few hard pure she. ";
        ...
        int result =  bruteForceStringMatching(text, "Consequat");
